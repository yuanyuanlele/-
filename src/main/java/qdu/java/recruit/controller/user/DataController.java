...
//        user = userService.getUser(5);
        ...
        try {
            List<PositionEntity> positionEntityList=positionService.listPosPage();
            List<PositionCompanyBO> posInfo=new ArrayList<PositionCompanyBO>();
            for(int i=0;i<positionEntityList.size();i++){
                PositionEntity positionEntity=positionEntityList.get(i);
                DepartmentEntity departmentEntity=departmentService.getDepartment(positionEntity.getDepartmentId());
                CompanyEntity companyEntity=companyService.getCompany(departmentEntity.getCompanyId());
                PositionCompanyBO positionCompanyBO=new PositionCompanyBO();
                positionCompanyBO.setCompanyId(companyEntity.getCompanyId());
                positionCompanyBO.setCompanyCode(companyEntity.getCompanyCode());
                positionCompanyBO.setCompanyLogo(companyEntity.getCompanyLogo());
                positionCompanyBO.setCompanyName(companyEntity.getCompanyName());
                positionCompanyBO.setDescription(companyEntity.getDescription());
                positionCompanyBO.setState(companyEntity.getState());
                positionCompanyBO.setPositionId(positionEntity.getPositionId());
                positionCompanyBO.setTitle(positionEntity.getTitle());
                positionCompanyBO.setRequirement(positionEntity.getRequirement());
                positionCompanyBO.setWorkCity(positionEntity.getWorkCity());
                positionCompanyBO.setSalaryUp(positionEntity.getSalaryUp());
                positionCompanyBO.setSalaryDown(positionEntity.getSalaryDown());
                positionCompanyBO.setReleaseDate(positionEntity.getReleaseDate());
                positionCompanyBO.setValidDate(positionEntity.getValidDate());
                positionCompanyBO.setStatePub(positionEntity.getStatePub());
                positionCompanyBO.setHits(positionEntity.getHits());
                positionCompanyBO.setCategoryId(positionEntity.getCategoryId());
                positionCompanyBO.setDepartmentId(positionEntity.getDepartmentId());
                positionCompanyBO.setHrIdPub(positionEntity.getHrIdPub());
                posInfo.add(positionCompanyBO);
